...
(function(e) {
    ...
    l.buttonSelector = function(a, b) {
        for (var c = [], d = function(a, b, c) {
                ...
                if (e.isArray(a) || a instanceof e) {
                    ...
                    f = 0;
                    for (h = i.length; f < h; f++) i[f].name === l && c.push({
                        inst: b,
                        node: i[f].node
                    })
                    ...
                    a.nodeName && (i = e.inArray(a, f), -1 !== i && c.push({
                        inst: b,
                        node: f[i]
                    }))
    ...
    i.Api.register("buttons.exportData()", function(a) {
        if (this.context.length) {
            ...
            b.select && "function" === typeof b.select.info && f.selected === m && b.rows(c.rows, e.extend({
                selected: !0
            }, f)).any() && e.extend(f, {
                selected: !0
            });
